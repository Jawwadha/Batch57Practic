...
let moviename: string = "Laagan";
console.log(moviename);

//Create a template string to introduce youself, including your name and age.
let myname: string = "Jawad Hameed";
let age: number = 45;
let introduction = `${"My name is"} ${myname} ${"and my age is"}  ${age} ${"Years."}`;
console.log(introduction);

//Initialize a constant with a type annotation for your cuurent mood as a boolean.
const ab: boolean = true;
let mood = "I am happy";
console.log(ab);

//Combine a user's first and last name using template liternals and log the full name.
let firstname: string = "Hafiz";
let lastname: string = "shahid";
let fullname: string = `${firstname} ${lastname}`;
console.log(fullname);

//Create a variable for a user's age with a type annotation and assign a number to it.
let user_age: number = 45;
console.log(`${user_age} ${"Years."}`);
//Use a template string to display a product name and its price.
let productname: string = "Dell Desktop";
let productprice: number = 150000;
...
let ufm: string = "Jawad";
let ulm: string = "Hameed";
let uage: number = 45;
