...
let temprature = 28;
if (temprature < 25) console.log("ITS COLD");
...
const num_array: number[] = [28, 36, 45, 67];
...
function wordsstart1(words: string[]): string[] {
...
// Example usage:
const wordsArray: string[] = ["apple", "banana", "orange", "grape", "apricot"];
const wordsStartingWithAArray: string[] = wordsstart1(wordsArray);
...
function minMaxAverage(input_array: number[]): {
  min: number;
  max: number;
  avg: number;
} {
