...
function adult_check(input_age) {
    if (input_age < 18) {
        console.log("Minor");
    }
    else {
...
const p_num_array = [20, -25, 35, -29, 33];
let c_cnt = 0;
...
function reverse_array(array_type) {
    let after_reverse = [];
    for (let i = array_type.length - 1; i >= 0; i--) {
...
function filter_false_value(ffv) {
    return ffv.filter(Boolean);
}
const arraybefore_falsevalue = [null, 0, " ", 3, undefined, false, 33, "Jawad"];
...
function sumevenodd(inputarr, isEven) {
    let ele_sum = 0;
...
function check_ele(inputarr, ele_num) {
    let ind_num;
...
function smallestnuminarray(inputarr) {
    let tmp_num = 0;
...
function calculateproduct(input_array) {
    let tmp_num = 0;
...
function filterByLength(input_array, str_len) {
    let output_array = [];
    let tmp_str;
...
function incrementAll(input_array) {
    let output_array = [];
    for (let i = 0; i < input_array.length; i++) {
...
function countOccurances(input_array, ele_num) {
    let output_array = [];
    let tmp_str = ele_num;
    let tmp_str2 = 0;
    for (let i = 0; i < input_array.length; i++) {
...
function formatintostring(input_array) {
    let format_string = "";
    let tmp_str = ", ";
    let tmp_str2 = " and ";
...
function FtoCelsius(input_array) {
    let N_FtoCelsius = [];
    let tempvar;
    // let tempvar2:string;
    for (let i = 0; i < input_array.length; i++) {
...
function minMaxAverage(input_array) {
...
function swapElements(input_array, First_index, second_index) {
...
function findcharnotime(input_char, fnd_char) {
    let cnt = 0;
...
const tofindchar_string = "Jawad Hameed";
...
function sortsmalltolarg(input_array) {
...
function reverse_array1(input_array) {
